...
public class UserService implements IUserService {
    ...
    User user= userRepository.save(new User(name,1500));
     return user;
    }
    ...
    List<User> userOrderWise=userRepository.findAll();
     Collections.sort(userOrderWise, asc);
     
     if(scoreOrder == ScoreOrder.DESC)
     {
        Collections.reverse(userOrderWise);
     }
     return userOrderWise;
    }
